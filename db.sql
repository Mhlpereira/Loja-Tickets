...
CREATE TABLE IF NOT EXISTS `partners` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_partners_users1_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_events_partners1_idx` (`partner_id` ASC),
...
CREATE TABLE IF NOT EXISTS `purchases` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_purchases_customers1_idx` (`customer_id` ASC),
...
CREATE TABLE IF NOT EXISTS `purchase_tickets` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_purchase_tickets_purchases1_idx` (`purchase_id` ASC),
  INDEX `fk_purchase_tickets_tickets1_idx` (`ticket_id` ASC),
...
CREATE TABLE IF NOT EXISTS `reservation_tickets` (
  ...
  `customer_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_reservation_tickets_tickets1_idx` (`ticket_id` ASC),
  INDEX `fk_reservation_tickets_customers1_idx` (`customer_id` ASC),
